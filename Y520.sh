...
kexts_exceptions="Sensors|FakePCIID_BCM57XX|FakePCIID_Intel_GbX|FakePCIID_XHCIMux|FakePCIID_Intel_HD|FakePCIID_AR9280_as_AR946x|BrcmFirmwareData|PatchRAM.kext"
